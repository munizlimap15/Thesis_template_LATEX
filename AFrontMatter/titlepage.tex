...
\renewcommand{\TitleTitleSetup}{Titel der Dissertation / Title of the Doctoral Thesis\par}
...
% -- Title Page
\Title{\textcolor{red}{Your title here \\ (To change, go to the file "titlepage.tex", which is inside the folder "AFrontMatter")}}
...
\Who{\textcolor{red}{Your name here (To change, go to the file "titlepage.tex", which is inside the folder "AFrontMatter")}} %Make sure you add all your titles! 
...
\Year{\textcolor{red}{2022}}
\ProgrammeCode{\textcolor{red}{796 605 452}}
\ProgrammeName{Geographie} %Make sure it has the same Name as in the Studienblatt
\Supervisor{Univ.-Prof. Dipl.-Geogr. Dr. Thomas Glade}
%\SupervisorTwo{} % Here you can change the row under the supervisor
